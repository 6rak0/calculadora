<script>
    ...
    function calcular() {
        ...
        const terminal = (tot - tot * 0.0336 - lab - mat - hon - isr).toFixed(2);
        const tresMeses = (tot - tot * 0.087 - lab - mat - hon - isr).toFixed(2);
        const seisMeses = (tot - tot * 0.1218 - lab - mat - hon - isr).toFixed(2);
        const nueveMeses = (tot - tot * 0.145 - lab - mat - hon - isr).toFixed(2);
        const doceMeses = (tot - tot * 0.1798 - lab - mat - hon - isr).toFixed(2);
        const totales = {
            efectivo,
            terminal,
            tresMeses,
